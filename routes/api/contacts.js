...
const { validationBody, isValidId, auth, upload } = require('../../middlewares')
...
router.post('/', auth, upload.single('avatar'), validationBody(contactSchemas.schemaAddContact), controllerWrapper(contactsController.addContact))
